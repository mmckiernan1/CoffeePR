...
export function GuidedPayrollRun({
  ...
  function go(next: number) {
    setStep(Math.min(Math.max(next, 0), 5));
  }
  ...
  return (
    <RunPayrollShell
      ...
      detail={step === 0 ? "Tell Comcheq what is different this pay period. If nothing changed, you can keep moving." : undefined}
    >
      {step === 0 && (
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <button type="button" onClick={onOpenEmployees} className="group rounded-2xl border border-[#c9d5e6] bg-white p-5 text-left transition hover:border-[#8fb0e8] hover:bg-[#f7f9fd]">
      ...
      {step === 1 && (
        <div>
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <Button type="button" variant="outline" onClick={onOpenEmployees} className="border-[#c9d5e6] bg-white text-[#17428e]">Manage employees</Button>
          </div>
